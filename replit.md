...
### Shah Mobile Store (`artifacts/shah-mobile`)
...
**Key files:**
- `src/data/products.ts` — Add/edit product listings here (name, brand, price, image path, specs)
- `src/pages/home.tsx` — Homepage with catalog and filters
- `src/pages/product-detail.tsx` — Product detail view
- `src/components/layout.tsx` — Header + footer layout

**WhatsApp Contact:** +923001234567
